...
const translations = {
  en: {
    ...
    resources: {
      upload: {
        ...
        form: {
          ...
          tags: 'Tags',
          tagsPlaceholder: 'Add relevant tags to help others find your resource',
        },
        validation: {
    ...
    leaderboard: {
      ...
      badgeDescriptions: {
        'Rookie Uploader': 'First steps in knowledge sharing! Uploaded first resource.',
        'Resource Master': 'Consistent high-quality resource contributions.',
        'Knowledge Sharer': 'Active sharing of valuable knowledge with the community.',
  ...
  ar: {
    ...
    resources: {
      upload: {
        ...
        form: {
          ...
          tagsPlaceholder: 'أضف كلمات دلالية ذات صلة لمساعدة الآخرين على العثور على مواردك',
        },
        validation: {
      ...
      details: {
        ...
        deleteConfirmation: {
          title: 'حذف المورد',
          message: 'هل أنت متأكد من رغبتك في حذف هذا المورد؟ لا يمكن التراجع عن هذا الإجراء.',
          cancelButton: 'إلغاء',
          deleteButton: 'حذف'
        }
      }
    ...
    leaderboard: {
      ...
      badgeDescriptions: {
        'Rookie Uploader': 'الخطوات الأولى في مشاركة المعرفة! قام بتحميل أول مورد.',
    ...
    dashboard: {
      ...
      dataLoadError: 'فشل تحميل بيانات لوحة المعلومات. يرجى المحاولة مرة أخرى لاحقًا.',
