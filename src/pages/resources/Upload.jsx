...
export default function Upload() {
  ...
  const handleFileChange = (e) => {
    ...
    // Validate file type
    if (selectedFile && !['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'video/mp4'].includes(selectedFile.type)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setError('');
      setLoading(true);
      const response = await axios.post('https://notes-app-ibkq.onrender.com/api/resources', formDataToSend, {
        headers: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              required
            >
              <option value="">{t('common.select')} {t('resources.upload.form.type')}</option>
          ...
          <div>
            ...
            <select
              ...
              required
            >
              <option value="">{t('common.select')} {t('resources.upload.form.category')}</option>
          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
            <div className="space-y-1 text-center">
              ...
              <div className="flex text-sm text-gray-600">
                <label htmlFor="file" className="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500">
